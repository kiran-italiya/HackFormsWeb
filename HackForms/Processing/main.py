...
class ProcessForm:
	...
	def process_filled_form(self, df, img_name, df_final):
		...
		cv2.waitKey(0)
		cv2.destroyAllWindows()
		dummy = [np.nan] * len(df_final.columns)
		df_final = df_final.append(dummy)
...
pf = ProcessForm()
pf.processForm('k2.jpg',os.path.join(os.getcwd(),"data"))

#TODO fix problem reverse two extra coordinates box